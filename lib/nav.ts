...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Cosmos DB", href: "/inventory/cosmos-db", icon: Globe },
      { label: "AKS Clusters", href: "/inventory/aks", icon: Container },
    ],
  },
  {
    label: "Networking",
    items: [
      ...
      { label: "Load Balancers", href: "/networking/load-balancers", icon: Scale },
      { label: "ExpressRoute Circuits", href: "/networking/expressroute", icon: Cable },
      { label: "VNet Gateways (VPN/ER)", href: "/networking/vnet-gateways", icon: Router },
      { label: "Azure Firewalls", href: "/networking/firewalls", icon: Flame },
      { label: "Front Door", href: "/networking/front-door", icon: DoorOpen },
